...
class _EventsCalendarPageState extends State<EventsCalendarPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        // Remove the grey background color
        child: Column(
          children: [
            TableCalendar(
              ...
              calendarStyle: CalendarStyle(
                ...
                todayDecoration: BoxDecoration(
                  color: Colors.grey, // Set current day background to blue
                  shape: BoxShape.rectangle,
                ...
                defaultBuilder: (context, day, focusedDay) {
                  return Container(
                    decoration: BoxDecoration(
                      color:
                          _getHeatmapColor(day), // Heatmap color for each day
                      shape: BoxShape.rectangle,
                      borderRadius: BorderRadius.circular(8),
                    ),
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(
                        color: Colors.black, // Keep the text color solid black
                        fontWeight:
